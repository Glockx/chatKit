...
//  checkIn.iOS
//
//  Created by Nijat Muzaffarli on 2021/11/21.
//
...
private enum Unit: Int, Equatable {
    case point = 0
    case ratio
...
open class PinStackView: UIView {
    ...
    public var iteminfos = NSMapTable<UIView, PinStackItemInfo>.weakToStrongObjects()
